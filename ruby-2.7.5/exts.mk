...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/rubyvm/. ext/objspace/. ext/gdbm/. ext/fcntl/. \
	     ext/pty/. ext/cgi/escape/. ext/stringio/. ext/monitor/. \
	     ext/readline/. ext/psych/. ext/fiber/. ext/racc/cparse/. \
	     ext/zlib/. ext/-test-/arith_seq/extract/. \
	     ...
	     ext/-test-/wait_for_single_fd/. ext/json/. \
	     ext/json/generator/. ext/json/parser/. ext/strscan/. \
	     ext/dbm/. ext/etc/. ext/sdbm/. ext/ripper/. ext/date/. \
	     ext/syslog/. ext/continuation/. ext/pathname/. \
	     ext/rbconfig/sizeof/. ext/coverage/. ext/openssl/. \
	     ext/digest/. ext/digest/bubblebabble/. ext/digest/md5/. \
	     ext/digest/rmd160/. ext/digest/sha1/. ext/digest/sha2/. \
	     ext/bigdecimal/. ext/io/console/. ext/io/nonblock/. \
	     ext/io/wait/. ext/socket/. ext/fiddle/. ext/nkf/.
EXTOBJS = dmyext.o
